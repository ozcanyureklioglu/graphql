...
const resolvers = {
  ...
  Mutation:{
      addUser:(parent,{data},{pubsub})=>{
        ...
        users.push(user);
        pubsub.publish('createdUser',{createdUser:user});
        return true;
      },
      addEvent:(parent,{data},{pubsub})=>{
          ...
          events.push(event);
          pubsub.publish('createdEvent',{createdEvent:event});
          return true;
      },
      ...
      addParticipant:(parent,{data},{pubsub})=>{
          ...
          pubsub.publish('createdParticipant',{createdParticipant:parti});
          return parti;
      },
  ...
  Subscription: {
      createdUser:{
          subscribe:(_,__,{pubsub}) => pubsub.asyncIterator('createdUser'),
      },
      createdEvent:{
          subscribe: (_,__,{pubsub})=> pubsub.asyncIterator('createdEvent'),
      },
      createdParticipant:{
          subscribe:(_,__,{pubsub})=> pubsub.asyncIterator('createdParticipant'),
      },
  }
